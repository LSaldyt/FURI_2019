...
\begin{abstract}
    ...
    This project aims to prototype a higher-level, quantum-classical-hybrid programming language for expressing probabilistic computations easily.
    The MIT cognitive science community has produced many developments using probabilistic programming languages [TODO: Cite]. 
